  ...
  return (
    <div className="p-4 w-1/4 text-white">
      <Tooltip content={info?.menu || 'Crear Menu'}>
        {!isNew ? (
          <div onClick={onOpen} className="cursor-pointer flex shadow-lg rounded-lg h-full p-4 pr-8 gap-2 flex-row relative bg-card border border-gray/20">
          ...
          <div onClick={onOpen} className="flex shadow-lg rounded-lg gap-2 h-full py-4 justify-center items-center cursor-pointer bg-card border border-gray/20">
